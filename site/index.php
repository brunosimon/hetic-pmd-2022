...
<head>
    <meta charset="UTF-8">
    <title>Développement Web - PMD 2019 - Bruno Simon</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">PMD 2019 - Dév<span class="hidden-xs">eloppement</span> Web</a>
            <ul class="nav navbar-nav navbar-right">
                <li><a class="btn btn-light" href="https://github.com/brunosimon/hetic-p2023" target="_blank">GitHub</a></li>
            </ul>
        </div>
    </nav>
